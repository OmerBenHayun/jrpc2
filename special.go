...
func (s *Server) handleRPCCancel(ctx context.Context, req *Request) (interface{}, func(),error) {
	if !InboundRequest(ctx).IsNotification() {
		return nil, nil, code.MethodNotFound.Err()
	}
...
type methodFunc func(context.Context, *Request) (interface{}, func(),error)

func (m methodFunc) Handle(ctx context.Context, req *Request) (interface{}, func(), error) {
	return m(ctx, req)
}

// Handle the special rpc.serverInfo method, that requests server vitals.
func (s *Server) handleRPCServerInfo(context.Context, *Request) (interface{}, func(), error) {
	return s.ServerInfo(), nil, nil
}
